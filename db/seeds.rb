...
framework = Word.create!(word_requested: "Framework", word_translated: "Cadre", language_requested: "en", language_translated: "fr", context_details: "How on earth can we implement a framework if we do not have the people on the ground who have the capacity to execute them? ", progress: "Nouveau", favorite: "false", user_id: celine.id, category_id: webdev.id)
database = Word.create!(word_requested: "Database", word_translated: "Base de données", language_requested: "en", language_translated: "fr", context_details: "The Agency will then include this information in a classification and labelling inventory in the form of a database accessible via internet. ", progress: "Nouveau", favorite: "false", user_id: celine.id, category_id: webdev.id)
server = Word.create!(word_requested: "Server", word_translated: "Serveur", language_requested: "en", language_translated: "fr", context_details: "The advantage is that the pages will not have to be transferred from the original server each time. ", progress: "En cours", favorite: "true", user_id: celine.id, category_id: webdev.id)
layout = Word.create!(word_requested: "Layout", word_translated: "Disposition", language_requested: "en", language_translated: "fr", context_details: " - The lever and buttons are designed and placed on same layout as the arcade style. ", progress: "En cours", favorite: "true", user_id: celine.id, category_id: webdev.id)
web_browser = Word.create!(word_requested: "Web browser", word_translated: "navigateur Web", language_requested: "en", language_translated: "fr", context_details: "NB: We advise you not to install two RSS extensions at the same time as this may cause conflicts which could block your web browser. ", progress: "En cours", favorite: "false", user_id: celine.id, category_id: webdev.id)
requests = Word.create!(word_requested: "Requests", word_translated: "demandes", language_requested: "en", language_translated: "fr", context_details: "Requests may be sent by mail, e-mail or online using our web request forms. ", progress: "Appris", favorite: "false", user_id: celine.id, category_id: webdev.id)
fixing_bugs = Word.create!(word_requested: "Fixing bugs", word_translated: "correction de bugs", language_requested: "en", language_translated: "fr", context_details: "There's always room for improvement. Whether it's boosting performance, adding new features or fixing bugs. ", progress: "Appris", favorite: "true", user_id: celine.id, category_id: webdev.id)
markup_language = Word.create!(word_requested: "Markup Language", word_translated: "Langage de balisage", language_requested: "en", language_translated: "fr", context_details: "A wiki is a website that allows users to easily add content to a series of linked web pages using simplified Web markup language. ", progress: "Nouveau", favorite: "false", user_id: celine.id, category_id: webdev.id)
compiling = Word.create!(word_requested: "Compiling", word_translated: "compiler", language_requested: "en", language_translated: "fr", context_details: "The process of compiling and analysing the control data for the purpose of the annual report may facilitate Member States [...] ", progress: "Nouveau", favorite: "false", user_id: celine.id, category_id: webdev.id)
operating_system = Word.create!(word_requested: "Operating system", word_translated: "Système opérateur", language_requested: "en", language_translated: "fr", context_details: "It has a fixed operating system, which has been customised for video games. ", progress: "En cours", favorite: "true", user_id: celine.id, category_id: webdev.id)
